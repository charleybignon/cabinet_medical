        ...
        <div class="col-md-5 mb-3 border border-dark rounded-3 shadow-lg">
            <div class="user-item d-flex align-items-center">
                ...
                <div class="user-details flex-grow-1">
                    <h5><?= $this->lastName . ' ' . $this->firstName ?></h5>
                </div>
                <button type="button" class="btn btn-primary col-2 mb-3" data-bs-toggle="modal" data-bs-target="#editUserModal<?= $this->idUser ?>">
        ...
        <div class="modal fade" id="editUserModal<?= $this->idUser ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <form action="<?= $_SERVER["REQUEST_URI"] ?>" method="POST">
                    ...
                    <input type="hidden" name="id" value="<?= htmlentities($this->idUser) ?>">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="inputDoctor" class="form-select" name="idDoctor" required>
                                                ...
                                                <?php foreach ($doctors as $doctor) : ?>
                                                    <option value="<?= $doctor->idDoctor ?>" <?= ($doctor->idDoctor == $this->idDoctor) ? 'selected' : '' ?>>
