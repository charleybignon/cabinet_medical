...
class Doctor {
    ...
    public function getCardDoctor(){
        ob_start(); ?>
        <div class="col-md-5 mb-3 border border-dark rounded-3">
            <div class="user-item d-flex align-items-center">
                ...
                <button type="button" class="btn btn-primary col-2 mb-3" data-bs-toggle="modal" data-bs-target="#editDoctorModal<?= $this->idDoctor ?>">
                ...
                <form action="<?= $_SERVER["REQUEST_URI"] ?>" method="POST">
                    ...
                    <button class="btn btn-primary col-2 btn-removed">
