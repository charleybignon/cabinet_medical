...
<div class="container">
    ...
    <button type="button " class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addUserModal">Ajouter un usager</button>
    <?php
        if (!empty($usagers)){?>
                            ...
                            <fieldset class="row col-6 border border-dark rounded-3 p-0 mb-4 me-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="inputPostal" type="number" pattern="[0-9]{5}" class="form-control" name="postalCode" required>
                                    </div>
                                </div>
